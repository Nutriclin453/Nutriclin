  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 ml-64 flex flex-col overflow-hidden">
        <TopNav />
        <main className="mt-16 p-8 overflow-y-auto h-full custom-scrollbar">
          <div className="max-w-7xl mx-auto space-y-12">
            ...
            <section className="relative rounded-3xl overflow-hidden bg-surface-container border border-outline-variant flex flex-col md:flex-row shadow-xl">
              ...
              <div className="md:w-2/3 p-12 flex flex-col justify-center space-y-6">
                <div>
                  ...
                  <h1 className="text-5xl font-black text-on-surface mt-4 tracking-tighter">Antonio Feitoza</h1>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                  ...
                  <div className="space-y-8 border-l border-outline-variant ml-6 pl-8 relative">
                    {[
                      ...
                      <div key={i} className="relative">
                        ...
                        <h3 className="font-bold text-on-surface flex items-center justify-between">
              ...
              <div className="md:col-span-4 space-y-8">
                <section className="bg-surface-container p-8 rounded-3xl border border-outline-variant space-y-8 h-full">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4 group cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="font-black text-on-surface">@nutryantoniofeitoza</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 group cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="font-black text-on-surface truncate max-w-[180px]">tonymab1@icloud.com</p>
                      </div>
                    </div>
                  </div>
            ...
            {/* Footer Text */}
            <footer className="pt-12 border-t border-outline-variant flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">
              <div className="flex items-center gap-4">
